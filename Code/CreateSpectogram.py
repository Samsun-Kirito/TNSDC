...
def genres_to_csv(genres_array,genre_name,window_type='hamming') : 
    ...
    csv_file = f"C\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Data\\FeaturesCsv\\{genre_name}_{window_type}" 
...
def process_genres(genre_array,genre_name,window_type='hamming') : 
    ...
    for idx,genre in enumerate(genre_array): 
        ...
        plt.savefig(f"C:\\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Spectograms\\Test\\genres{genre_name}\\{genre_name}{idx}.jpg', bbox_inches='tight', dpi=300")  
        plt.close()
...
def Main():  
    ...
    blues= load_from_folder("C:\\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Data\\Test\\model_test\\blues_wav")  
    print('blues okey')
    
    classical = load_from_folder("C:\\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Data\\Test\\model_test\\classical_wav")  
    print('classic okey')

    disco= load_from_folder("C:\\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Data\\Test\\model_test\\disco_wav") 
    print('disco okey')

    
    metal = load_from_folder("C:\\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Data\\Test\\model_test\\metal_wav")   
    print('metal okey')

    country = load_from_folder("C:\\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Data\\Test\\model_test\\country_wav") 
    print('country okey')
    
    jazz = load_from_folder("C:\\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Data\\Test\\model_test\\jazz_wav")  
    print('jazz okey')

    pop= load_from_folder("C:\\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Data\\Test\\model_test\\pop_wav")  
    print('pop okey')
   
    reggae = load_from_folder("C:\\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Data\\Test\\model_test\\reggae_wav")  
    print('reggea okey')
   
    rock = load_from_folder("C:\\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Data\\Test\\model_test\\rock_wav")   
    print('rock okey') 


    hiphop = load_from_folder("C:\\Users\\samsu\\OneDrive\\Documents\\Musical_Genre_Classification-main\\Data\\Test\\model_test\\Hiphop_wav")   
    print('hiphop okey')
